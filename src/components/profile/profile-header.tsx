    ...
    <Card className="p-6">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
        <div className="relative">
          ...
          <Button size="icon" variant="secondary" className="absolute bottom-0 right-0 w-8 h-8 rounded-full shadow-lg">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="text-muted-foreground mt-1">john.doe@agrofund.com</p>
